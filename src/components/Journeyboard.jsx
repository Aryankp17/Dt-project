...
const Journeyboard = () => {
  ...
  return (
    <div className='sidebar w-70 border-t-0 overflow-hidden bg-white border-0 rounded-xl rounded-tl-none rounded-bl-none shadow-2xl h-80 flex flex-col fixed top-16.5' style={{transition:'transform 0.3s ease-in-out',
     transform:(open) ? 'translateX(0%)':'translateX(-85%)'}}>
            ...
            <div className='py-4 px-3 ml-2 leading-4 flex flex-col gap-3 text-black text-sm'>
